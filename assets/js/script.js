      ...
      fetch(requestUrlUv)
        ...
        .then(function (data) {
          ...
          $.each(data.daily, function (index, val) {
            if (index < 5) {
                forecastInfo += "<p>";
                forecastInfo += "<b>Day: " + (index + 1) + "</b><br>";
                forecastInfo += "<b>Temp: " + val.temp.day + " &degF</b><br>";
                forecastInfo += "<b>Wind: " + val.wind_speed + " MPH</b><br>";
                forecastInfo += "<b>Humidity: " + val.humidity + " %</b><br>";
